  ...
  return (
    <>
      <div className="flex flex-col gap-4">
        ...
        >
          {fileName ? <p className="text-sm font-medium">{fileName}</p> : <p className="text-sm text-muted-foreground">{t('import.uploadStep.dragDrop')}</p>}
        ...
        <div className="flex flex-col gap-2">
          ...
          <Select value={selectedAccountId !== null ? String(selectedAccountId) : ''} onValueChange={handleAccountChange}>
            <SelectTrigger>

        ...
        {loadedProfileName === null ? (
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex gap-2">
              ...
              />
              <Button type="button" onClick={() => void handleSaveNew()} disabled={!profileName.trim() || saving}>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-2">
              ...
              />
              <Button type="button" onClick={() => void handleSaveNew()} disabled={!profileName.trim() || saving} variant="outline">
